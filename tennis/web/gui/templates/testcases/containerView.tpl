    ...
    <div id="tproject_control_panel" style="">
        ...
        <form method="post" action="lib/testcases/containerEdit.php">
          <fieldset class="text-center center-block">
            <h3>Opérations sur les dossiers de tests</h3>
            <hr>
          <input type="hidden" name="CSRFName" id="CSRFName" value="CSRFGuard_1591936788">
          <input type="hidden" name="CSRFToken" id="CSRFToken" value="37f119e3d4f52606db04da204369eca1505f85425aaf05f9947c6a05a052c8ecd9ae133db5fed74a4fde70386b7e58409b2eb341e02f2e90361a420e8afe13a2">
          <input type="hidden" name="treeFormToken" id="treeFormToken" value="0">
          ...
          <a href="javascript:location='lib/testcases/tcImport.php?containerID=1&amp;bIntoProject=1&amp;useRecursion=1&amp;'" class="btn btn-info"  title="Importer">Importer</a>

          <a href="javascript:location='lib/testcases/tcExport.php?tproject_id=1&amp;containerID=1&amp;form_token=0&amp;useRecursion=1&amp;form_token=0'" class="btn btn-secondary" title="Exporter tous les dossiers de tests">Exporter</a>

          <a href="javascript:window.open('lib/results/printDocument.php?type=testspec&amp;level=testproject&amp;allOptionsOn=1&amp;format=0&amp;id=1&amp;form_token=0')" class="btn btn-primary" title="Document de spécification de test (HTML) dans une nouvelle fenêtre">Ouvrir dans une nouvelle fenêtre</a>

          <a href="javascript:window.open('lib/results/printDocument.php?type=testspec&amp;level=testproject&amp;allOptionsOn=1&amp;format=4&amp;id=1')" class="btn btn-outline-dark" title="Télécharger le document de spécification de test (Pseudo Word)">Télécharger le document</a>
          </fieldset>
        </form>
    </div>
    <hr>
