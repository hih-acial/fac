...
<div class="form-group">
	<label for="idSRS">{$labels.req_spec}</label>
		<select class="form-control" name="idSRS" id="idSRS" onchange="form.submit()">
...
{if $gui->showCloseButton}
  <form name="closeMeTop">
    <div class="groupBtn">
      <input class="btn btn-outline-danger" type="button" value="{$labels.btn_close}"
...
{/if}
  ...
  <h2>{$labels.req_title_assigned}</h2>
    ...
    {if $smarty.section.row.total > 0}
    	<div class="groupBtn">
    		<input class="btn btn-outline-dark" type="submit" name="unassign" value="{$labels.btn_unassign}"
  ...
  {/if}
    ...
    {if $gui->arrUnassignedReq ne ""}
      ...
      <div class="groupBtn">
      	<input class="btn btn-outline-success" type="submit" name="assign" value="{$labels.btn_assign}"
