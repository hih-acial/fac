...
<div class="container">
    ...
    <div>
        ...
        <form method="post" id="create_build" name="create_build"
              action="{$managerURL}" onSubmit="return validateForm(this);">
            <input type="hidden" name="tplan_id" id="tplan_id" value="{$gui->tplan_id}">
            <div class="form-group">
                <label for="build_name">{$labels.enter_build}</label>
                <input class="form-control" type="text" name="build_name" id="build_name"
            ...
            <div class="center-block text-center">
                ...
                <input class="btn btn-primary" type="submit" name="{$gui->buttonCfg->name}" value="{$gui->buttonCfg->value|escape}"
                       onclick="do_action.value='{$gui->buttonCfg->name}'"/>
                <input class="btn btn-secondary" type="button" name="go_back" value="{$labels.cancel}"
                       onclick="location.href=fRoot+'{$cancelAction}';"/>
