...
<div class="container">
	<h4>{$labels.caption_search_form_req}</h4>

<form method="post" action="{$basehref}lib/requirements/reqSearch.php" target="workframe">
	<table class="table">
		<tr>
			<td>{$labels.requirement_document_id}</td>
			<td><input class="form-control" type="text" name="requirement_document_id" size="{#REQDOCID_SIZE#}" maxlength="{#REQDOCID_MAXLEN#}" /></td>
		</tr>
		
		<tr>
			<td>{$labels.version}</td>
			<td><input class="form-control" type="text" name="version"
			           size="{#VERSION_SIZE#}" maxlength="{#VERSION_MAXLEN#}" /></td>
		</tr>
		
		<tr>
			<td>{$labels.title}</td>
			<td><input class="form-control" type="text" name="name" size="{#REQNAME_SIZE#}" maxlength="{#REQNAME_MAXLEN#}" /></td>
		</tr>
		...
		<tr>
			<td>{$labels.status}</td>
     		<td><select class="form-control" name="reqStatus">
     		<option value="">&nbsp;</option>
		...
		{if $gui->filter_by.expected_coverage}
			<tr>
				...
				<td><input class="form-control" type="text" name="coverage" size="{#COVERAGE_SIZE#}" maxlength="{#COVERAGE_MAXLEN#}" /></td>
			</tr>
		{/if}		
		...
		<tr>
			...
			<td><input class="form-control" type="text" name="tcid" value="{$gui->tcasePrefix}"
